                    ...
                    <ItemTemplate>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="ibtnEdit" runat="server" ImageUrl="~/Images/Edit2.jpg" Height="40px" Width="40px" OnCommand="ibtnEdit_Click" CommandArgument='<%#Eval("PATIENT_ID") %>' ToolTip="Edit Patient's Personal Information" />
                                </td>
