...
Public Class AddDataTier
    ...
    Public Sub AddPhysician(ByVal Fname As String, ByVal Midinit As String, ByVal Lname As String, ByVal DOB As String, ByVal HmPn As String, ByVal Cell As String, ByVal Gender As String, ByVal Address As String, ByVal City As String, ByVal State As String, ByVal Zip As String)
        Try
    ...
    Public Function AddPrescription(ByVal patID As Int32, ByVal physID As Int32, ByVal rx As String, ByVal dosage As String, ByVal intake As String, ByVal freq As String, ByVal refill As Int32) As Boolean
        Try
